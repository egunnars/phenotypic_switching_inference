function [params, scale_mle, optvalue, feasible] = estimation_mle_num(data,dead,C,N,T,x0,scale,Aineq,bineq,Aeq,beq,lb,ub,tol)
...
[params, optvalue] = fmincon(@(param) neg_log_likelihood_num(param,scale,C,N,data,dead,T),x0,Aineq,bineq,Aeq,beq,lb,ub,[],options);
