function [params, error, scale_mle, scale_error, optvalue, feasible] = estimation_mle_frac_error_simple(ratios,C,Ntot,alpha,T,x0,scale,Aineq,bineq,Aeq,beq,lb,ub,tol)
...
[params_error, optvalue] = fmincon(@(param) neg_log_likelihood_frac_error_simple(param,scale_new,C,Ntot,alpha,ratios,T),x0_new,Aineq_new,bineq,Aeq_new,beq,lb_new,ub_new,[],options);
