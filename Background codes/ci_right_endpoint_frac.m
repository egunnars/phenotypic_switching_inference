function [ci_ub,ci_yvalues_ub,ci_ub_check] = ci_right_endpoint_frac(data,C,Ntot,alpha,T,mle,scale,optlikelihood,Aineq,bineq,Aeq,beq,lb,ub,i,j,quant,tol)
...
ci_yvalues_ub = neg_log_likelihood_frac(sol,scale,C,Ntot,alpha,data,T);
sol = sol.*scale;
ci_ub = sol(i,j);
