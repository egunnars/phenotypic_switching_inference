function [ci_lb,ci_yvalues_lb,ci_lb_check] = ci_left_endpoint_frac_error(data,C,Ntot,alpha,T,mle,scale,optlikelihood,Aineq,bineq,Aeq,beq,lb,ub,i,j,quant,tol)
...
ci_yvalues_lb = neg_log_likelihood_frac_error(sol,scale_new,C,Ntot,alpha,data,T);
